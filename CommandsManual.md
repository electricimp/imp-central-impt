...
The `--output <mode>` option (alias: `-z`) can be used to adjust an output generated by a command. This option may be repeated multiple times for the same command to specify multiple adjustments. If the option is not specified the default verbose output is generated by the command.
